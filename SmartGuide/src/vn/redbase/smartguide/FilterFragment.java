...
public class FilterFragment extends Fragment {
	...
	private final FilterItem[] mItemList = new FilterItem[] {
			...
			new FilterItem(R.drawable.icon13, R.drawable.icon13_gray, "D", "U�?NG", "drink"),
			new FilterItem(R.drawable.icon14, R.drawable.icon14_gray, "H", "SỨC KHỎE", "health&fitness"),
			new FilterItem(R.drawable.icon15, R.drawable.icon15_gray, "E", "GIẢI TR�?", "entertainment"),
			...
			new FilterItem(R.drawable.icon19, R.drawable.icon19_gray, "D", "GI�?O DỤC", "education"),
	};
