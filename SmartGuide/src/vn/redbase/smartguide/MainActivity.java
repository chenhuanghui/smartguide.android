...
public class MainActivity extends FragmentActivity implements MainAcitivyListener {
	...
	void updateCategoryList(){
		...
		((CategoryListFragment)mFragmentList.get(0)).updateCategoryList();
	}
	...
	public class UpdateCityList extends AsyncTask<Void, Void, Boolean> {    	
		...
		protected void onPostExecute(Boolean k) { 
			try{
				...
				mLocationTV.setText(GlobalVariable.mCityNames.get(GlobalVariable.mCityIDes.indexOf(GlobalVariable.mCityID)));
			}catch(Exception ex){
