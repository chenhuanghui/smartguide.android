...
//
//public class ShopDetailActivity_back extends FragmentActivity {
//
...
//				mTaskList.remove(this);
//				CyUtils.showError("Không thể lấy chi tiết cửa hàng", e, ShopDetailActivity_back.this);
//			}
//		};
//		mTaskList.add(task);
...
//		sShop = s;
//		Intent intent = new Intent(act, ShopDetailActivity_back.class);
...
//				ScanCodeActivity.newInstance(ShopDetailActivity_back.this);
//			}
//		};
//
...
//					CyUtils.showError("Không thể tải ảnh khuyến mãi", e, ShopDetailActivity_back.this);
//				}
//			}
//			, new Point(), this);
//		}
